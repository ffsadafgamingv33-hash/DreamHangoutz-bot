...
function handleViewCodes(message, args, client) {
  ...
  const embed = new EmbedBuilder()
    ...
    .addFields(
      { name: '💰 10 Credit Code', value: 'Price: **50,000 credits**\nUse: `+redeemshop buy 10`', inline: true },
      { name: '💰 100 Credit Code', value: 'Price: **500,000 credits**\nUse: `+redeemshop buy 100`', inline: true },
      ...
      { name: 'Available Codes', value: `**${stats.available}** unused codes remaining`, inline: false }
    )
